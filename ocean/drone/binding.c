...
void my_init(Env* env, Dict* kwargs) {
    ...
    env->race_lookahead_segment_coef = dict_get(kwargs, "race_lookahead_segment_coef")->value;
    env->race_lookahead_gate_dist = dict_get(kwargs, "race_lookahead_gate_dist")->value;
